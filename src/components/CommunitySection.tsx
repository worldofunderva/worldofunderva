...
import { MessageCircle, Youtube, BookOpen, ArrowUpRight, Facebook, Linkedin, LucideProps } from 'lucide-react';
import { ScrollReveal, StaggerContainer, StaggerItem } from '@/components/ui/scroll-reveal';
import { cn } from '@/lib/utils';

const XIcon = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>((props, ref) => (
  <svg ref={ref} viewBox="0 0 24 24" className="h-4 w-4 sm:h-5 sm:w-5 fill-current" aria-hidden="true" {...props}>
...
const socialLinks = [
  ...
  { name: 'Discord', icon: DiscordIcon, url: 'https://discord.gg/worldofunderva', color: 'hover:bg-[#5865F2]/10 hover:border-[#5865F2]/50' },
