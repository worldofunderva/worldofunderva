    ...
    <section id="pillars" className="relative py-20 sm:py-28 lg:py-36">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        <ScrollReveal className="mx-auto max-w-2xl text-center mb-12 sm:mb-16">
          <p className="text-sm font-medium text-primary mb-3 tracking-wide">RWA ECOSYSTEM</p>
        ...
        {/* Pillars Grid */}
        <StaggerContainer className="grid gap-5 sm:gap-6 md:grid-cols-2 lg:grid-cols-3" staggerDelay={0.15}>
          {pillars.map((pillar) => (
            <StaggerItem key={pillar.title}>
              <div
                className={cn(
                  "group relative rounded-2xl border border-border bg-card p-6 sm:p-7 lg:p-8 transition-all duration-300 h-full",
              ...
              >
                ...
                <div className="relative z-10">
                  {/* Icon */}
                  <div className="mb-5 sm:mb-6 inline-flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-xl bg-primary/10 text-primary">
                    <pillar.icon className="h-6 w-6 sm:h-7 sm:w-7" />
                  </div>

                  {/* Title */}
                  <h3 className="text-xl sm:text-xl font-semibold mb-1">{pillar.title}</h3>
                  <p className="text-sm text-primary mb-4">{pillar.subtitle}</p>

                  {/* Description */}
                  <p className="text-sm sm:text-sm text-muted-foreground mb-5 sm:mb-6 leading-relaxed">
                    {pillar.description}
                  </p>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 text-sm font-medium text-primary transition-all group-hover:gap-2"
                  >
                    Explore Division
