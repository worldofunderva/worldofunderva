  ...
  return (
    <div className="space-y-8">
      <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
        The World of Underva ecosystem is built to harmonize institutional grade financial security with 
      ...
      <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
        ...
        a separation of powers between operational execution and automated audit verification. 
        The ecosystem is designed to be resilient, transparent, and scalable. Multi Party Computation (MPC) vaults 
        protect treasury and operational assets, while an AI driven auditing architecture ensures that every 
      ...
      <div className="rounded-xl border border-primary/10 bg-card p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {[
            ...
            { icon: CreditCard, label: 'Hybrid Payments', desc: 'Fiat via Stripe combined with $WOU token rails' },
          ].map((item) => (
      ...
      <div className="rounded-xl border border-primary/10 bg-card p-6">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed mb-4">
          To ensure mainstream accessibility and industrial scalability, each pillar uses a Hybrid Payment System:
        </p>
        <div className="space-y-3">
          <div className="flex items-start gap-3 rounded-lg bg-secondary/30 p-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">Accepted via Stripe integration for participants who are not yet using cryptocurrency.</p>
            </div>
          </div>
          <div className="flex items-start gap-3 rounded-lg bg-primary/5 border border-primary/10 p-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">Used by ecosystem participants to unlock automated rewards and "Corporate Tender" benefits.</p>
            </div>
          </div>
        </div>
        <p className="text-xs text-muted-foreground mt-3 italic">
          While fiat is accepted for initial access, the $WOU token is the exclusive vehicle for generating and receiving rewards.
        </p>
      </div>
    </div>
  );
