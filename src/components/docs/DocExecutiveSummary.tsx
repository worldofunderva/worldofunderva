  ...
  return (
    <div className="space-y-8">
      <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
        ...
        architected to bridge the gap between high-velocity physical commerce and blockchain-based transparency. 
        ...
        participants to engage in a symbiotic economy of retail, sport, and logistics.
      </p>

      <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
        By bypassing traditional venture capital, we ensure fiduciary alignment remains solely with our community 
        of Sentinel holders, utilizing an autonomous, on-demand UNDO AI auditing protocol to maintain the 
