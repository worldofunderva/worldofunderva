  ...
  return (
    <div className="space-y-8">
      <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
        ...
        industrial integrity of the ecosystem. Authority is split between the Organization (responsible for operational 
      ...
      <div className="rounded-xl border border-primary/20 bg-primary/5 p-6">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed mb-4">
          ...
          direction remains aligned with the needs and values of its stakeholders.
        </p>
        <div className="space-y-3">
          {[
            ...
            },
            {
              ...
              desc: 'Sentinel NFT holders possess "Voting Standing" for specific ecosystem parameters, such as the cadence of cashback distributions or the adjustment of reward tier thresholds. This ensures that those most invested in the ecosystem have direct influence on its reward mechanics.',
            },
            {
              title: 'Transparent Coordination',
              desc: 'All discussions and community sentiment polling take place within the private Sentinel Assembly Discord, where the Announcer Agent provides real time updates on status, ensuring all participants have access to the same information.',
            },
          ].map((item) => (
      ...
      <div className="rounded-xl border border-primary/10 bg-card p-6">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed mb-4">
          To keep the project sustainable and legally compliant, the Organization retains 
